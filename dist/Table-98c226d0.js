import { defineComponent as ye, toRefs as $e, computed as O, openBlock as d, createElementBlock as v, normalizeClass as F, unref as a, withModifiers as de, createElementVNode as _e, normalizeStyle as se, ref as g, onUnmounted as Be, onMounted as Le, watch as Ce, nextTick as Re, withMemo as We, renderSlot as p, createBlock as He, createCommentVNode as w, createTextVNode as ge, Fragment as C, renderList as q, createVNode as we, toDisplayString as je, withCtx as S } from "vue";
...
const Fe = { class: "scrollbar" }, Ie = /* @__PURE__ */ ye({
  ...
  emits: ["mousedown"],
  setup(ne, { emit: Q }) {
    const re = ne, { active: Z, mode: X, thumbOffset: te, thumbSize: A } = $e(re), m = O(() => {
      const [i, z] = X.value === "vertical" ? ["top", "height"] : ["left", "width"];
      return {
        [i]: `calc(3px + ${te.value} * (100% - ${A.value} - 6px))`,
        [z]: `${A.value}`
      };
    });
    return (i, z) => (d(), v("div", {
      class: F(["scrollable-area", { active: a(Z), [a(X)]: !0 }]),
      onMousedown: z[0] || (z[0] = de((_) => Q("mousedown", _), ["stop"]))
    }, [
      _e("div", Fe, [
        _e("div", {
          class: "thumb",
...
const Se = /* @__PURE__ */ Te(Ie, [["__scopeId", "data-v-56aba386"]]), Ue = /* @__PURE__ */ ye({
  ...
  setup(ne, { emit: Q }) {
    const re = ne, { mode: Z, relativeTo: X, scrollPosition: te, scrollHeightDelta: A, scrollWidthDelta: m, staticPosition: i } = $e(re), z = g(!1), _ = g(0), B = g(0), I = g(0), T = g(0), k = g(), x = g(), K = g(), oe = g(), D = g(), L = g(0), H = g(0), b = g(), W = O(() => L.value / (T.value - B.value)), U = O(
      () => `max(56px, (100% - 14px) * ${B.value / T.value})`
    ), G = O(
      () => `max(56px, (100% - 14px) * ${_.value / I.value})`
    ), ue = O(() => H.value / (I.value - _.value)), N = g();
    Be(() => {
      J.disconnect(), ve.disconnect();
    });
    const y = () => {
      k.value && (b.value !== void 0 && (clearTimeout(b.value), b.value = void 0), z.value = !1, k.value = void 0);
    }, le = () => X != null && X.value ? X.value() : N.value, V = (n) => {
      const E = le();
      E && E.scrollTo(n);
    }, ce = (n) => {
      V({
      ...
      V({
        top: ((D == null ? void 0 : D.value) ?? 0) + n * I.value / (_.value - A.value)
      });
    }, ae = (n) => {
      if (k.value) {
        switch (k.value) {
          case "horizontal":
            ce(n.clientX - ((x == null ? void 0 : x.value) ?? 0));
            break;
          case "vertical":
            ie(n.clientY - ((K == null ? void 0 : K.value) ?? 0));
            break;
        }
        n.preventDefault();
      }
      ...
      I.value !== n.scrollHeight && (I.value = n.scrollHeight);
    }, j = (n) => {
    ...
    return Le(() => {
      ...
      a(Z) !== "vertical" ? (d(), He(Se, {
        key: 2,
        onMousedown: E[1] || (E[1] = de((P) => c(P, "horizontal"), ["stop"])),
      ...
      a(Z) === "both-top" ? (d(), He(Se, {
        key: 3,
        onMousedown: E[2] || (E[2] = de((P) => c(P, "horizontal"), ["stop"])),
        active: T.value > B.value && (z.value || k.value === "horizontal"),
        class: F({ "scrollbar-visible": T.value > B.value }),
        thumbOffset: W.value,
        thumbSize: U.value,
      ...
      a(Z) !== "horizontal" ? (d(), He(Se, {
        key: 4,
        onMousedown: E[3] || (E[3] = de((P) => c(P, "vertical"), ["stop"])),
        active: I.value > _.value && (z.value || k.value === "vertical"),
        class: F({ "scrollbar-visible": I.value > _.value }),
...
const Xe = /* @__PURE__ */ Te(Ue, [["__scopeId", "data-v-21092b38"]]), Ae = ["onClick", "onMousedown", "data-column"], qe = ["onClick"], Ge = ["data-column"], Ye = {
  ...
  setup(ne, { emit: Q }) {
    const re = ne, {
      ...
      showTotal: L,
      showTopTotal: H
    } = $e(re), b = g(), W = g(), U = g(0), G = g(0), ue = g(0), N = g({}), y = O(
      ...
      if (m.value[l].type === "string")
        return;
      let r = t, s = ie.value[l], h = ce.value[l];
    ...
    }, ve = (t) => t.subindex === void 0 ? t.index + 1 : `${t.index + 1}.${t.subindex + 1}`, fe = (t) => A.value.findIndex((l) => l === t), me = (t) => te.value && !["date", "string"].includes(m.value[t].type), he = (t, l) => {
      ...
      _.value && (b.value = y.value.indexOf(t), W.value = b.value, U.value = 0, G.value = l.clientX, ue.value = l.clientX, window.addEventListener("mousemove", E), window.addEventListener("mouseup", P));
    }, E = (t) => {
      if (b.value === void 0)
        return;
      U.value++, ue.value = t.clientX;
      ...
      V.value && W.value !== b.value && Q("move:column", {
        from: b.value,
        to: W.value
      }), W.value = void 0, U.value = 0, b.value = void 0, window.removeEventListener("mousemove", E), window.removeEventListener("mouseup", P);
    }, Ne = (t) => {
...
const Oe = /* @__PURE__ */ Te(st, [["__scopeId", "data-v-6c07e227"]]), rt = /* @__PURE__ */ ye({
  ...
  setup(ne) {
    ...
    }, ie = new ResizeObserver(() => ce()), ae = g();
    return Re(() => {
      ie.disconnect(), ae.value && ie.observe(ae.value);
    }), Ce(k, (u, c) => {
      W.value = Math.random(), c.length || ce();
    }), (u, c) => (d(), v("div", {
      ...
      we(Xe, {
        ...
        default: S(() => [
          we(Oe, {
            ...
            inversedKpis: a(B),
            orderBy: a(I),
            orderColumnType: a(A)[a(I)[0][0]].type,
            primaryColumn: a(T),
            rows: a(k),
            showNoDataMessage: !0,
            showRowNumber: a(K),
            ...
            topTotal: S(({ columnKey: o, subcolumnKey: f, values: $ }) => [
              o in U.value ? p(u.$slots, "topTotal", {
                key: 0,
                columnKey: o,
                subcolumnKey: f,
                values: $
            ...
            secondaryColumn: S(({ columnKey: o, subcolumnKey: f }) => [
              o in U.value ? p(u.$slots, "secondaryColumn", {
                key: 0,
                columnKey: o,
                subcolumnKey: f
              }, void 0, !0) : w("", !0)
...
const ct = /* @__PURE__ */ Te(rt, [["__scopeId", "data-v-53697fcb"]]);
export {
  Xe as S,
  ct as T,
  Se as a,

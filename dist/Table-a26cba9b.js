import { defineComponent as ye, toRefs as $e, computed as O, openBlock as d, createElementBlock as v, normalizeClass as F, unref as a, withModifiers as ce, createElementVNode as _e, normalizeStyle as se, ref as b, onUnmounted as Be, onMounted as Le, watch as we, nextTick as Re, withMemo as We, renderSlot as p, createBlock as He, createCommentVNode as w, createTextVNode as be, Fragment as C, renderList as q, createVNode as Ce, toDisplayString as je, withCtx as S } from "vue";
...
const Se = /* @__PURE__ */ Te(Ie, [["__scopeId", "data-v-56aba386"]]), Ue = /* @__PURE__ */ ye({
  ...
  setup(ne, { emit: Q }) {
    const re = ne, { mode: Z, relativeTo: A, scrollPosition: te, scrollHeightDelta: I, scrollWidthDelta: m, staticPosition: i } = $e(re), z = b(!1), _ = b(0), B = b(0), U = b(0), T = b(0), k = b(), x = b(), K = b(), oe = b(), D = b(), L = b(0), H = b(0), g = b(), W = O(() => L.value / (T.value - B.value)), X = O(
      () => `max(56px, (100% - 14px) * ${B.value / T.value})`
    ), G = O(
      () => `max(56px, (100% - 14px) * ${_.value / U.value})`
    ), ue = O(() => H.value / (U.value - _.value)), N = b();
    Be(() => {
      J.disconnect(), ve.disconnect();
    });
    const y = () => {
      k.value && (g.value !== void 0 && (clearTimeout(g.value), g.value = void 0), z.value = !1, k.value = void 0);
      ...
      R(), !k.value && (y(), z.value = !0, g.value = window.setTimeout(() => {
        z.value = !1;
      }, 2500));
    }, he = () => {
      J.disconnect(), ve.disconnect();
...
const Xe = /* @__PURE__ */ Te(Ue, [["__scopeId", "data-v-21092b38"]]), Ae = ["onClick", "onMousedown", "data-column"], qe = ["onClick"], Ge = ["data-column"], Ye = {
  ...
  setup(ne, { emit: Q }) {
    const re = ne, {
      ...
      showTotal: L,
      showTopTotal: H
    } = $e(re), g = b(), W = b(), X = b(0), G = b(0), ue = b(0), N = b({}), y = O(
      ...
      return {
        ...
        dragged: g.value ? y.value[g.value] === t : !1,
        "drag-mode": V.value,
      ...
      const l = {};
      if (N.value[t])
        if (g.value !== void 0 && y.value[g.value] === t) {
          ...
          let r = (() => {
            if (g.value === void 0 || W.value === void 0)
              return 0;
            if (g.value < e) {
              if (W.value >= e)
                return -N.value[y.value[g.value]].width;
            } else if (W.value <= e)
              return N.value[y.value[g.value]].width;
            return 0;
          })();
      ...
      if (i && i.value && m.value[t].colspan && l === void 0 || g.value !== void 0 && V.value && y.value[g.value] === t)
        return;
      const e = [t];
      ...
      _.value && (g.value = y.value.indexOf(t), W.value = g.value, X.value = 0, G.value = l.clientX, ue.value = l.clientX, window.addEventListener("mousemove", E), window.addEventListener("mouseup", P));
    }, E = (t) => {
      if (g.value === void 0)
        return;
      ...
      const l = Object.entries(m.value).filter(([M, pe]) => pe.visible).map(([M]) => M).map((M, pe) => ({
        ...
        sizing: N.value[M]
      })), e = l[g.value].sizing, r = e.width / 2, h = e.left + ue.value - G.value;
      W.value = (() => {
      ...
      if (g.value === void 0 || W.value === void 0)
        return;
      V.value && W.value !== g.value && Q("move:column", {
        from: g.value,
        to: W.value
      }), W.value = void 0, X.value = 0, g.value = void 0, window.removeEventListener("mousemove", E), window.removeEventListener("mouseup", P);
    }, Ne = (t) => {
...
const Oe = /* @__PURE__ */ Te(st, [["__scopeId", "data-v-6c07e227"]]), rt = /* @__PURE__ */ ye({
  ...
  setup(ne) {
    ...
    const X = O(
      ...
      var c, o, f;
      const u = {};
      return (c = H.value) != null && c.main && (u["--header-main-height"] = `${H.value.main}px`), (o = H.value) != null && o.secondary && (u["--header-secondary-height"] = `${H.value.secondary}px`), L.value && (u["--fixed-width"] = `${L.value}px`), (f = H.value) != null && f.total && (u["--header-total-height"] = `${H.value.total}px`), g.value ? (u["--total-height"] = `${g.value}px`, u["--bottom-height"] = u["--total-height"]) : (ue.value === 1 ? u["--total-scrollbar-display"] = "none" : u["--total-height"] = "20px", u["--bottom-height"] = "0px"), u;
    }), y = b(), le = b(), V = b(!1), ie = () => {
      if (V.value)
        return;
      V.value = !0, L.value = 0, H.value = void 0, g.value = 0;
      const u = (c) => {
        const o = {
          hasSecondary: !1,
          mainColumnHeight: 0,
    ...
    return Re(() => {
      ...
      Ce(Xe, {
        ...
        scrollHeightDelta: (H.value ? H.value.total : 0) + g.value - 40,
        scrollPosition: a(x),

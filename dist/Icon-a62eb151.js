...
import { BaseError as $ } from "./utils/error.js";
import { m as b } from "./match-b8889c93.js";
const g = /* @__PURE__ */ p({
  __name: "Align",
  props: {
...
const B = /* @__PURE__ */ p({
  ...
  setup(t) {
    const o = t, { backend: l, elevation: n, mood: e, size: a, value: s } = f(o), c = _(
      () => b(l.value).when("boxicons", () => ({ bx: !0, [`bx-${s.value}`]: !0 })).when("boxicons-logo", () => ({ bx: !0, [`bxl-${s.value}`]: !0 })).when("boxicons-solid", () => ({ bx: !0, [`bxs-${s.value}`]: !0 })).when("flag-icons", () => ({ fi: !0, [`fi-${s.value}`]: !0 })).when("flag-icons-square", () => ({ fi: !0, fis: !0, [`fi-${s.value}`]: !0 })).or((r) => {
        throw new I(r);
      }).done
    ), u = _(() => ({
      ...c.value,
...
const M = /* @__PURE__ */ v(B, [["__scopeId", "data-v-41d9241a"]]);
export {
  U as A,
  q as C,
  M as I

import { defineComponent as ye, toRefs as $e, computed as B, openBlock as d, createElementBlock as v, normalizeClass as I, unref as l, withModifiers as pe, createElementVNode as _e, normalizeStyle as ie, ref as g, onUnmounted as Be, onMounted as Le, watch as we, nextTick as Re, withMemo as We, renderSlot as p, createBlock as He, createCommentVNode as C, createTextVNode as ge, Fragment as w, renderList as G, createVNode as Ce, toDisplayString as je, withCtx as S } from "vue";
...
const Fe = { class: "scrollbar" }, Ie = /* @__PURE__ */ ye({
  ...
  emits: ["mousedown"],
  setup(ce, { emit: Q }) {
    const de = ce, { active: Z, mode: A, thumbOffset: le, thumbSize: q } = $e(de), m = B(() => {
...
const Se = /* @__PURE__ */ Te(Ie, [["__scopeId", "data-v-56aba386"]]), Ue = /* @__PURE__ */ ye({
  ...
  setup(ce, { emit: Q }) {
    const de = ce, { mode: Z, relativeTo: A, scrollPosition: le, scrollHeightDelta: q, scrollWidthDelta: m, staticPosition: i } = $e(de), _ = g(!1), O = g(0), N = g(0), U = g(0), $ = g(0), k = g(), x = g(), oe = g(), ae = g(), W = g(), j = g(0), H = g(0), b = g(), E = B(() => j.value / ($.value - N.value)), X = B(
      () => `max(56px, (100% - 14px) * ${N.value / $.value})`
    ), Y = B(
      () => `max(56px, (100% - 14px) * ${O.value / U.value})`
    ), ve = B(() => H.value / (U.value - O.value)), D = g();
    Be(() => {
    ...
    return Le(() => {
      ...
      l(Z) !== "vertical" ? (d(), He(Se, {
        key: 2,
        onMousedown: P[1] || (P[1] = pe((F) => c(F, "horizontal"), ["stop"])),
      ...
      l(Z) === "both-top" ? (d(), He(Se, {
        key: 3,
        onMousedown: P[2] || (P[2] = pe((F) => c(F, "horizontal"), ["stop"])),
        active: $.value > N.value && (_.value || k.value === "horizontal"),
        class: I({ "scrollbar-visible": $.value > N.value }),
        thumbOffset: E.value,
        thumbSize: X.value,
...
const Xe = /* @__PURE__ */ Te(Ue, [["__scopeId", "data-v-21092b38"]]), Ae = ["onClick", "onMousedown", "data-column"], qe = ["onClick"], Ge = ["data-column"], Ye = {
  ...
  setup(ce, { emit: Q }) {
    const de = ce, {
      ...
      showTotal: j,
      showTopTotal: H
    } = $e(de), b = g(), E = g(), X = g(0), Y = g(0), ve = g(0), D = g({}), y = B(
      ...
      if (D.value[t])
        if (b.value !== void 0 && y.value[b.value] === t) {
          ...
          o.left = `${Math.floor(r + ve.value - Y.value)}px`, o.height = `${e + 1}px`, o.width = `${Math.round(s)}px`;
        } else {
      ...
      O.value && (b.value = y.value.indexOf(t), E.value = b.value, X.value = 0, Y.value = o.clientX, ve.value = o.clientX, window.addEventListener("mousemove", P), window.addEventListener("mouseup", F));
    }, P = (t) => {
      if (b.value === void 0)
        return;
      X.value++, ve.value = t.clientX;
      const o = Object.entries(m.value).filter(([M, me]) => me.visible).map(([M]) => M).map((M, me) => ({
        columnIndex: parseInt(me.toString()),
        sizing: D.value[M]
      })), e = o[b.value].sizing, r = e.width / 2, h = e.left + ve.value - Y.value;
      E.value = (() => {
    ...
    return we(
      ...
      (d(!0), v(w, null, G(y.value, (e) => (d(), v(w, null, [
      ...
      l(O) ? (d(!0), v(w, { key: 1 }, G(y.value, (e) => (d(), v(w, null, [
        l(m)[e].visible ? (d(), v("div", {
          key: 0,
      ...
      (d(!0), v(w, null, G(l(Z), (e, r) => (d(), v(w, null, [
        l(W) ? (d(), v("div", Ye, [
          Ce(Pe, {
            value: e.icon
          }, null, 8, ["value"])
        ])) : C("", !0),
        (d(!0), v(w, null, G(y.value, (s) => (d(), v("div", {
      ...
      l(H) && l(j) ? (d(), v(w, { key: 2 }, [
        ...
        (d(!0), v(w, null, G(y.value, (e) => (d(), v(w, null, [
          l(m)[e].visible ? (d(), v(w, { key: 0 }, [
            l(i) && (l(m)[e].colspan || 1) !== 1 ? (d(!0), v(w, { key: 0 }, G(l(m)[e].colspan, (r) => (d(), v("div", {
      ...
      l(i) ? (d(!0), v(w, { key: 3 }, G(y.value, (e) => (d(), v(w, null, [
        l(m)[e].visible && l(m)[e].colspan ? (d(!0), v(w, { key: 0 }, G(l(m)[e].colspan, (r) => (d(), v("div", {
      ...
      (d(!0), v(w, null, G(u.value, (e, r) => (d(), v(w, null, [
        l(W) ? (d(), v("div", {
          key: 0,
        ...
        (d(!0), v(w, null, G(y.value, (s) => (d(), v(w, null, [
          ...
          ], 10, Ke)) : (d(!0), v(w, { key: 1 }, G(l(m)[s].colspan, (h) => (d(), v("div", {
...
const Oe = /* @__PURE__ */ Te(st, [["__scopeId", "data-v-6c07e227"]]), rt = /* @__PURE__ */ ye({
  ...
  setup(ce) {
    ...
    Be(() => fe.disconnect());
    const X = B(
      () => Object.keys(q.value).slice(0, O.value).reduce((u, c) => (u[c] = q.value[c], u), {})
    ), Y = B(
      () => Object.keys(q.value).slice(O.value).reduce((u, c) => (u[c] = q.value[c], u), {})
    ), ve = B(
      ...
      var c, a, f;
      const u = {};
      return (c = H.value) != null && c.main && (u["--header-main-height"] = `${H.value.main}px`), (a = H.value) != null && a.secondary && (u["--header-secondary-height"] = `${H.value.secondary}px`), j.value && (u["--fixed-width"] = `${j.value}px`), (f = H.value) != null && f.total && (u["--header-total-height"] = `${H.value.total}px`), b.value ? (u["--total-height"] = `${b.value}px`, u["--bottom-height"] = u["--total-height"]) : (ve.value === 1 ? u["--total-scrollbar-display"] = "none" : u["--total-height"] = "20px", u["--bottom-height"] = "0px"), u;
    }), y = g(), se = g(), V = g(!1), he = () => {
      var f, R;
      if (V.value)
        return;
      ...
      const u = (z) => {
        ...
        if (!z)
          return T;
        const J = [...z.querySelectorAll(".cell.column-main:not(.column-main-extended)")], L = [...z.querySelectorAll(".cell.column-main.column-main-extended")], ue = z.querySelector(".cell.column-secondary"), ne = z.querySelector(".cell.total"), K = [];
      ...
      }, c = u((f = y.value) == null ? void 0 : f.$el), a = u((R = se.value) == null ? void 0 : R.$el);
      if (a.hasSecondary)
        j.value = c.width, H.value = {
...
const vt = /* @__PURE__ */ Te(rt, [["__scopeId", "data-v-1112f913"]]);
export {
  Xe as S,
  vt as T,
  Se as a,

export const sortInsensitive = <T extends { toString(): string }>(leftValue: T, rightValue: T): number => {
...
export const sortCallback = <T, S>(callback: (value: T) => S) => (leftValue: T, rightValue: T): number => {
...
export const sortMultiple = (...callbacks: ((leftValue: any, rightValue: any) => number)[]) => (leftValue: any, rightValue: any) => {
